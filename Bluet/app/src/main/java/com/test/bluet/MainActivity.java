...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnSpeakerOn = (Button)findViewById(R.id.btn_speaker_on);
        mBtnSpeakerOff = (Button)findViewById(R.id.btn_speaker_off);
        mBtnFanOn = (Button)findViewById(R.id.btn_fan_on);
        mBtnFanOff = (Button)findViewById(R.id.btn_fan_off);
        mBtnPair = (Button)findViewById(R.id.btn_pair);

        context_main = this;

        CircleProgressBar mPbar_temp = findViewById(R.id.pbar_temp);
        CircleProgressBar mPbar_humid = findViewById(R.id.pbar_humid);
            ...
            public void handleMessage(android.os.Message msg){
                ...
                if(msg.what == BT_MESSAGE_READ){
                    ...
                    if(readMessage.charAt(4) == ',') {
                        ...
                        MainActivity.Timer_thread thread_1 = new MainActivity.Timer_thread();
                        thread_1.start();
                    }
                    else {
    ...
    void connectSelectedDevice(String selectedDeviceName) {
        ...
        try {
            ...
            try {
                ...
                Toast.makeText(getApplicationContext(), "블루투스 커넥트 중 오류가 발생했습니다.", Toast.LENGTH_LONG).show();
            }
